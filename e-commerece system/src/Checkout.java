...
public class Checkout {
 private static void shipmentService(Cart c){
	 ...
	 for(Map.Entry<Shippable,Integer> entry:shipment.entrySet()){
		 ...
		 System.out.println(entry.getValue()+"X "+entry.getKey().getName()+"     "+entry.getKey().getWeight()+" kg");
 ...
 public static void checkOut(Customer c){
	 ...
	 for(Map.Entry<Product,Integer> entry:cart.getItems().entrySet()){
		 System.out.println(entry.getValue()+"X "+entry.getKey().getName()+"     "+entry.getKey().getPrice()+" EGP");
	 }
	 System.out.println("------------------------------------");
	 System.out.println("Subtotal: "+subTotal+" EGP");
	 System.out.println("shippingFees: "+shippingFees+" EGP");
	 System.out.println("Amount: "+totalCost+" EGP");
	 System.out.println();
	 System.out.println("Current balance after payment: "+c.getBalance()+" EGP");
 }
}
